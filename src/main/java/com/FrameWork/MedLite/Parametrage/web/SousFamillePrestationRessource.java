...
import com.FrameWork.MedLite.Parametrage.service.SousFamillePrestationService;
...
public class SousFamillePrestationRessource {
    ...
    public ResponseEntity<List<SousFamillePrestationDTO>> getAllSousFamillePrestationByActif(@RequestParam Boolean actif) {
        return ResponseEntity.ok().body(sousFamillePrestationService.findAllSousFamillePrestationByActif(actif));
    }
