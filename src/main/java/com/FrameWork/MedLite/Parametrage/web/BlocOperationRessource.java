...
import com.FrameWork.MedLite.Parametrage.service.BlocOperationService;
...
public class BlocOperationRessource {
    ...
    public ResponseEntity<BlocOperationDTO> getBlocOperationByCode(@PathVariable Integer code) {
      ...
      @GetMapping("bloc_operation/findBy")
    public ResponseEntity<List<BlocOperationDTO>> getAllBlocOperationByActif(@RequestParam Boolean actif) {
        return ResponseEntity.ok().body(blocOperationService.findAllBlocOperationByActif(actif));
    }
