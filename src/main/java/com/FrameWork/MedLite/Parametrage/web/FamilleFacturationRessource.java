...
import com.FrameWork.MedLite.Parametrage.service.FamilleFacturationService;
...
public class FamilleFacturationRessource {
    ...
    @GetMapping("famille_facturation/findBy")
    public ResponseEntity<List<FamilleFacturationDTO>> getAllFamilleFacturationByActif(@RequestParam Boolean actif) {
        return ResponseEntity.ok().body(familleFacturationService.findAllFamilleFacturationByActif(actif));
    }
