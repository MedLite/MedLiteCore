...
public class Operation {
    ...
    @Column(name = "Autorise_Modif_Intervenant", columnDefinition = "bit")
    ...
    @Column(name = "Code_Famille_Operation", updatable = false, insertable = false)
    ...
    @JoinColumn(name = "Code_Type_Operation", referencedColumnName = "Code", nullable = false)
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    @JsonBackReference
    private TypeOperation typeOperation;

    @Column(name = "Code_Type_Operation", updatable = false, insertable = false)
