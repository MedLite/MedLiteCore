...
import com.FrameWork.MedLite.Parametrage.factory.VilleFactory;
import com.FrameWork.MedLite.Parametrage.repository.VilleRepo;
...
public class VilleService {
    ...
    public List<VilleDTO> findAllVille() {
        return VilleFactory.listVilleToVilleDTOs(villeRepo.findAll(Sort.by("code").descending()));
