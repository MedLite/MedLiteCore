 ...
 */
@Entity
@Table(name = "Cheif_Complaint", schema = "dmi")
@Audited
@AuditTable("Cheif_Complaint_AUD")
public class CheifComplaint {
    ...
    @Column(name = "Cheif_Complaint", nullable = false, length = 255, columnDefinition = "nvarchar(max)")
